        ...
        return (
          <div className="w-full h-full bg-gradient-to-b from-orange-900 to-red-700 flex flex-col">
            <div className="flex items-center justify-between p-4 pt-16 text-white">
              <button
                onClick={goHome}
                className="flex items-center gap-1 text-orange-400 hover:text-orange-300 active:scale-95 transition-all"
              >
                <span className="text-xl">‹</span>
                <span>Back</span>
              </button>
        ...
        return (
          <div className="w-full h-full bg-gradient-to-b from-purple-900 to-pink-700 flex flex-col">
            <div className="flex items-center justify-between p-4 pt-16 text-white">
              <button
                onClick={goHome}
                className="flex items-center gap-1 text-purple-400 hover:text-purple-300 active:scale-95 transition-all"
              >
                <span className="text-xl">‹</span>
                <span>Back</span>
              </button>
        ...
        return (
          <div className="w-full h-full bg-gradient-to-b from-yellow-900 to-orange-700 flex flex-col">
            <div className="flex items-center justify-between p-4 pt-16 text-white">
              <button
                onClick={goHome}
                className="flex items-center gap-1 text-yellow-400 hover:text-yellow-300 active:scale-95 transition-all"
              >
                <span className="text-xl">‹</span>
                <span>Back</span>
              </button>
